...
namespace Thesis.Infrastructure.Migrations
{
    ...
    [Migration("20260514172653_AddFinanceManager")]
    partial class AddFinanceManager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thesis.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Thesis.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("5e4f2a02-7d75-410b-81c8-3c4e31b062fa"),
                            CreatedAt = new DateOnly(2026, 5, 10),
            ...
            modelBuilder.Entity("Thesis.Domain.Entities.Payment", b =>
                {
                    b.HasOne("Thesis.Domain.Entities.Project", null)
                        .WithMany()
